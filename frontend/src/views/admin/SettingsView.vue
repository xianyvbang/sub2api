      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          <div class="border-b border-gray-100 px-6 py-4 dark:border-dark-700">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
              {{ t('modelMarketplace.heroDescription') }}
            </p>
          </div>
          <div class="space-y-5 p-6">
            <div class="flex items-center justify-between gap-4">
              <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('modelMarketplace.adminEnabledHint') }}
                </p>
              </div>
            ...
            <div class="flex items-center justify-between gap-4">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('modelMarketplace.adminLoginRequired') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('modelMarketplace.adminLoginRequiredHint') }}
                </p>
              </div>
              <Toggle
                v-model="form.model_marketplace_requires_login"
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      model_marketplace_requires_login:
        form.model_marketplace_requires_login,
      // Model Plaza feature switches + description
