 ...
 * @param rateProtectionData - Optional rate multiplier protection fields
...
export async function create(
  ...
  rateProtectionData?: { rate_protection_enabled?: boolean; max_rate_multiplier?: number }
): Promise<ApiKey> {
  ...
  if (rateProtectionData?.rate_protection_enabled !== undefined) {
    payload.rate_protection_enabled = rateProtectionData.rate_protection_enabled
  }
  if (rateProtectionData?.max_rate_multiplier !== undefined) {
    payload.max_rate_multiplier = rateProtectionData.max_rate_multiplier
  }
