export default {
  ...
  modelMarketplace: {
    ...
    currentPrice: '现价',
    originalPrice: '原价',
    pricingSourceChannel: '渠道定价',
      pricingSourceGroup: '分组现价',
      priceUnavailable: '暂无价格',
      viewDetails: '查看分组明细',
      lowestPriceGroup: '最低展示价分组',
      displayPriceGroup: '当前展示分组',
      cardCount: 'Cards',
    inputPrice: '输入',
    outputPrice: '输出',
    cacheWritePrice: '缓存写入',
  ...
  admin: {
    ...
    redeem: {
      ...
      count: '数量',
      usageLimit: '可使用次数',
      perUserLimit: '每人最大可兑换次数',
      giftChildrenTitle: '关联余额兑换码',
      giftBalanceAmountRequired: '请输入有效的赠送余额金额',
      giftLimitRequired: '请输入有效的使用次数限制',
      giftLimitInvalid: '每人最大可兑换次数不能大于可使用次数',
      generate: '生成',
      copyAll: '全部复制',
      download: '下载',
