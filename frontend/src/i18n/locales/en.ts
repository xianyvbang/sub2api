export default {
  ...
  modelMarketplace: {
    ...
    billingModeImage: 'Image Per-request Billing',
    groupLabel: 'Group',
    ...
    pricingSourceChannel: 'Channel Price',
      pricingSourceGroup: 'Group Price',
      priceUnavailable: 'No price',
      viewDetails: 'View Group Details',
      lowestPriceGroup: 'Lowest-price Group',
      displayPriceGroup: 'Displayed Group',
      cardCount: 'Cards',
    inputPrice: 'Input',
    outputPrice: 'Output',
    cacheWritePrice: 'Cache Write',
  ...
  admin: {
    ...
    redeem: {
      ...
      giftChildrenTitle: 'Linked Balance Codes',
      giftBalanceAmountRequired: 'Enter a valid gift balance amount',
      giftLimitRequired: 'Enter valid usage limits',
      giftLimitInvalid: 'Per-user limit cannot be greater than usage limit',
      generating: 'Generating...',
      generate: 'Generate',
      copyAll: 'Copy All',
      copied: 'Copied!',
